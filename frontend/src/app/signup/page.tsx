  ...
  return (
    <AuthRedirectGuard>
      <main className="flex min-h-screen items-center justify-center p-4">
        <AuthCard title="Create Account" description="Start tracking watchlists and holdings in one place.">
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            Have an account? <Link className="font-medium text-primary" href="/login">Login</Link>
          </p>
        </AuthCard>
      </main>
    </AuthRedirectGuard>
